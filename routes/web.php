...
Route::middleware([
    ...
    Route::delete('/post/{post}', [PostController::class, 'destroy'])->middleware('permission:delete post');
    Route::delete('/delete-post/{post}', [PostController::class, 'delete'])->middleware('permission:delete post');
